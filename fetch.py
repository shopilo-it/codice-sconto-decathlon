#!/usr/bin/env python3
"""
Recupero codici sconto Decathlon da shopilo.it
Sursa: https://shopilo.it/negozi/decathlon.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/decathlon.it"
STORE_NAME = "Decathlon"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Decathlon da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-decathlon)"
    }
    try:
